                                ...
                                <form action="{{ route('app.vendors.update', $vendor->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name"
                                            ...
                                            placeholder="Tuliskan Nama Tipe" value="{{ $vendor->name }}">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option value="0"{{ $vendor->status == 0 ? 'selected' : '' }}>Tidak Aktif
                                            </option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback" style="display: block">
                                    ...
                                    <div class="text-right mt-3">
                                        ...
                                        <a href="{{ route('app.vendors.index') }}" class="btn btn-sm btn-info">
